function [l, u, l1, u1, l2, u2, flag] = boundsCov_resBen(YT1, YT2, YC1, YC2, d1, d2)
%This function calculates the bounds on the fraction who benefit, with a
%baseline variable and restriction on benefit.
...
%Subpopulation 2
%d1 applies to the restriction on benefit for Subpopulation 1 
%(i.e., Benefit = YT - YC <= d1 for Subpopulation 1)
%d2 applies to the restriction on benefit for Subpopulation 2 
%(i.e., Benefit = YT - YC <= d2 for Subpopulation 2)
...
%lflag and uflag are 0 if there was no error, and 1 otherwise
    [l1, u1, lflag1, uflag1] = boundsNoCov_mTmC_SPARSE_resBen(YT1, YC1, d1);
    [l2, u2, lflag2, uflag2] = boundsNoCov_mTmC_SPARSE_resBen(YT2, YC2, d2);
