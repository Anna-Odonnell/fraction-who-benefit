##IN THIS CODE:
##create Figure 2a
##estimate bounds for 30-day mRS score


##inclusion criteria:
##randomized, have 30-day mRS score, have NIHSS score
...
##All inclusion criteria have been met except have 30-day mRS score
