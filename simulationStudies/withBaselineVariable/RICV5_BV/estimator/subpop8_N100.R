...
##NOTE: For some of these simulations, there were zero treatment subjects
##or zero control subjects in a stratum of X (b/c the strata are fine and N is only 100)
##We let the bound estimates just be (0,1) for these simulations
#############################################################################
##Libraries##
#############################################################################
...
save(bounds, file="subpop8_N100.Rdata")
