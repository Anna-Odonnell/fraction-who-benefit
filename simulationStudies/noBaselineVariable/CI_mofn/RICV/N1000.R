...
val <- as.numeric(temp[1])
##This code was sent to cluster as 1 simulation per job
##Let val range from 1 to 10000 when submitting jobs 
...
save(bounds, LB.CI_mn, UB.CI_mn, file=paste("N1000","-","seed", val, "-", format(Sys.time(), "%Y%m%d-%H%M"),".Rdata", sep=""))  